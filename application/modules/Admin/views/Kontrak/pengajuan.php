        ...
        <div class="card">
            <div class="card-body">
                <form class="needs-validation" novalidate="" action="<?= base_url($ctrl . '/pengajuanAction') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        <label for="validationCustom01">Berkas Perpanjang Kontrak <small>format filenya doc/pdf</small></label>
                        <input type="file" name="berkas" id="validationCustom01" class="form-control" required>
                        <div class="invalid-feedback">
                            Harus di isi.
                        </div>
                    </div>
